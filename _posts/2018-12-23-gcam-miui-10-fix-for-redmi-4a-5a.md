...
[![](https://img.shields.io/github/downloads/:AzimsTech/:Camera2API-MIUI10-Fix-Redmi4A/:1/total.svg)](https://github.com/AzimsTech/Camera2API-MIUI10-Fix-Redmi4A/releases/download/1/Camera2API-MIUI10-Fix-Redmi4A.zip)
